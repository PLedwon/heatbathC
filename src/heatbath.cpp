...
const double TSPAN[2] = {0, 2.5*pow(10,3)};
...
int main() {
    ...
    double omegaMin=pow(N,-0.818388888), omegaMax=omegaMin*pow(N,1.0619444444444); //highest and lowest eigenfrequency of the bath
